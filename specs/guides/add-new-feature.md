...
## Шаг 7. Обновите специфы

Фича меняет поведение → обновите соответствующую специфу (или добавьте новую в
`components/`) **в том же изменении**. Специфы — зеркало кода (см.
[`README.md`](../README.md)).
