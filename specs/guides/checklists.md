...
- [ ] Слаг — настоящий английский (не транслит), ASCII kebab-case, одинаковый для ru/en, задан в `slug:`
- [ ] Директория `content/posts/<NN>-<slug>/`, файлы названы ровно `index.ru.md`/`index.en.md` (оба, или сознательно один язык)
...
- [ ] Если есть `cover`/инлайн-картинки — лежат в `images/` внутри директории поста
