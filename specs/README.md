...
Антона Воронцова на Hugo. Спецификации описывают **то, как проект устроен сейчас** —
...
> Спецификации — **зеркало кода**, а не ТЗ. Если код и спецификация расходятся — прав код,
> а спецификацию нужно поправить. При изменении поведения проекта соответствующую
> спецификацию обновляют в том же изменении.
...
Эти спецификации не заменяют, а дополняют существующие файлы:
- **`CLAUDE.md`** (корень) — операционные инструкции для агента, максимально плотные.
  Спецификации разворачивают их в структурированную документацию с примерами.
